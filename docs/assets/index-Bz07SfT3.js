var Wt=Object.defineProperty;var Yt=(a,n,e)=>n in a?Wt(a,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[n]=e;var i=(a,n,e)=>(Yt(a,typeof n!="symbol"?n+"":n,e),e);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))t(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&t(c)}).observe(document,{childList:!0,subtree:!0});function e(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(r){if(r.ep)return;r.ep=!0;const s=e(r);fetch(r.href,s)}})();/*! (c) Andrea Giammarchi @webreflection ISC */(function(){var a=function(d,o){var u=function(w){for(var b=0,v=w.length;b<v;b++)m(w[b])},m=function(w){var b=w.target,v=w.attributeName,P=w.oldValue;b.attributeChangedCallback(v,P,b.getAttribute(v))};return function(g,w){var b=g.constructor.observedAttributes;return b&&d(w).then(function(){new o(u).observe(g,{attributes:!0,attributeOldValue:!0,attributeFilter:b});for(var v=0,P=b.length;v<P;v++)g.hasAttribute(b[v])&&m({target:g,attributeName:b[v],oldValue:null})}),g}};function n(d,o){if(d){if(typeof d=="string")return e(d,o);var u=Object.prototype.toString.call(d).slice(8,-1);if(u==="Object"&&d.constructor&&(u=d.constructor.name),u==="Map"||u==="Set")return Array.from(d);if(u==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(u))return e(d,o)}}function e(d,o){(o==null||o>d.length)&&(o=d.length);for(var u=0,m=new Array(o);u<o;u++)m[u]=d[u];return m}function t(d,o){var u=typeof Symbol<"u"&&d[Symbol.iterator]||d["@@iterator"];if(!u){if(Array.isArray(d)||(u=n(d))||o&&d&&typeof d.length=="number"){u&&(d=u);var m=0,g=function(){};return{s:g,n:function(){return m>=d.length?{done:!0}:{done:!1,value:d[m++]}},e:function(P){throw P},f:g}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var w=!0,b=!1,v;return{s:function(){u=u.call(d)},n:function(){var P=u.next();return w=P.done,P},e:function(P){b=!0,v=P},f:function(){try{!w&&u.return!=null&&u.return()}finally{if(b)throw v}}}}/*! (c) Andrea Giammarchi - ISC */var r=!0,s=!1,c="querySelectorAll",p=function(o){var u=arguments.length>1&&arguments[1]!==void 0?arguments[1]:document,m=arguments.length>2&&arguments[2]!==void 0?arguments[2]:MutationObserver,g=arguments.length>3&&arguments[3]!==void 0?arguments[3]:["*"],w=function P(ue,pe,D,f,k,C){var O=t(ue),be;try{for(O.s();!(be=O.n()).done;){var R=be.value;(C||c in R)&&(k?D.has(R)||(D.add(R),f.delete(R),o(R,k)):f.has(R)||(f.add(R),D.delete(R),o(R,k)),C||P(R[c](pe),pe,D,f,k,r))}}catch(Ge){O.e(Ge)}finally{O.f()}},b=new m(function(P){if(g.length){var ue=g.join(","),pe=new Set,D=new Set,f=t(P),k;try{for(f.s();!(k=f.n()).done;){var C=k.value,O=C.addedNodes,be=C.removedNodes;w(be,ue,pe,D,s,s),w(O,ue,pe,D,r,s)}}catch(R){f.e(R)}finally{f.f()}}}),v=b.observe;return(b.observe=function(P){return v.call(b,P,{subtree:r,childList:r})})(u),b},y="querySelectorAll",x=self,I=x.document,H=x.Element,A=x.MutationObserver,_=x.Set,V=x.WeakMap,We=function(o){return y in o},Ye=[].filter,_e=function(d){var o=new V,u=function(f){for(var k=0,C=f.length;k<C;k++)o.delete(f[k])},m=function(){for(var f=ue.takeRecords(),k=0,C=f.length;k<C;k++)b(Ye.call(f[k].removedNodes,We),!1),b(Ye.call(f[k].addedNodes,We),!0)},g=function(f){return f.matches||f.webkitMatchesSelector||f.msMatchesSelector},w=function(f,k){var C;if(k)for(var O,be=g(f),R=0,Ge=v.length;R<Ge;R++)be.call(f,O=v[R])&&(o.has(f)||o.set(f,new _),C=o.get(f),C.has(O)||(C.add(O),d.handle(f,k,O)));else o.has(f)&&(C=o.get(f),o.delete(f),C.forEach(function(Jt){d.handle(f,k,Jt)}))},b=function(f){for(var k=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!0,C=0,O=f.length;C<O;C++)w(f[C],k)},v=d.query,P=d.root||I,ue=p(w,P,A,v),pe=H.prototype.attachShadow;return pe&&(H.prototype.attachShadow=function(D){var f=pe.call(this,D);return ue.observe(f),f}),v.length&&b(P[y](v)),{drop:u,flush:m,observer:ue,parse:b}},N=self,z=N.document,de=N.Map,Xe=N.MutationObserver,Te=N.Object,Ke=N.Set,Tt=N.WeakMap,Ze=N.Element,Mt=N.HTMLElement,Qe=N.Node,et=N.Error,tt=N.TypeError,Rt=N.Reflect,Me=Te.defineProperty,It=Te.keys,At=Te.getOwnPropertyNames,Se=Te.setPrototypeOf,Pe=!self.customElements,nt=function(o){for(var u=It(o),m=[],g=new Ke,w=u.length,b=0;b<w;b++){m[b]=o[u[b]];try{delete o[u[b]]}catch{g.add(b)}}return function(){for(var v=0;v<w;v++)g.has(v)||(o[u[v]]=m[v])}};if(Pe){var Ne=function(){var o=this.constructor;if(!ze.has(o))throw new tt("Illegal constructor");var u=ze.get(o);if(Ie)return ot(Ie,u);var m=rt.call(z,u);return ot(Se(m,o.prototype),u)},rt=z.createElement,ze=new de,Re=new de,st=new de,Ce=new de,it=[],Dt=function(o,u,m){var g=st.get(m);if(u&&!g.isPrototypeOf(o)){var w=nt(o);Ie=Se(o,g);try{new g.constructor}finally{Ie=null,w()}}var b="".concat(u?"":"dis","connectedCallback");b in g&&o[b]()},Ot=_e({query:it,handle:Dt}),Bt=Ot.parse,Ie=null,Fe=function(o){if(!Re.has(o)){var u,m=new Promise(function(g){u=g});Re.set(o,{$:m,_:u})}return Re.get(o).$},ot=a(Fe,Xe);self.customElements={define:function(o,u){if(Ce.has(o))throw new et('the name "'.concat(o,'" has already been used with this registry'));ze.set(u,o),st.set(o,u.prototype),Ce.set(o,u),it.push(o),Fe(o).then(function(){Bt(z.querySelectorAll(o))}),Re.get(o)._(u)},get:function(o){return Ce.get(o)},whenDefined:Fe},Me(Ne.prototype=Mt.prototype,"constructor",{value:Ne}),self.HTMLElement=Ne,z.createElement=function(d,o){var u=o&&o.is,m=u?Ce.get(u):Ce.get(d);return m?new m:rt.call(z,d)},"isConnected"in Qe.prototype||Me(Qe.prototype,"isConnected",{configurable:!0,get:function(){return!(this.ownerDocument.compareDocumentPosition(this)&this.DOCUMENT_POSITION_DISCONNECTED)}})}else if(Pe=!self.customElements.get("extends-br"),Pe)try{var at=function d(){return self.Reflect.construct(HTMLBRElement,[],d)};at.prototype=HTMLLIElement.prototype;var ct="extends-br";self.customElements.define("extends-br",at,{extends:"br"}),Pe=z.createElement("br",{is:ct}).outerHTML.indexOf(ct)<0;var lt=self.customElements,Ht=lt.get,_t=lt.whenDefined;self.customElements.whenDefined=function(d){var o=this;return _t.call(this,d).then(function(u){return u||Ht.call(o,d)})}}catch{}if(Pe){var dt=function(o){var u=je.get(o);gt(u.querySelectorAll(this),o.isConnected)},G=self.customElements,ut=z.createElement,Nt=G.define,zt=G.get,Ft=G.upgrade,jt=Rt||{construct:function(o){return o.call(this)}},Vt=jt.construct,je=new Tt,Ve=new Ke,Ae=new de,De=new de,pt=new de,Oe=new de,ht=[],Be=[],mt=function(o){return Oe.get(o)||zt.call(G,o)},qt=function(o,u,m){var g=pt.get(m);if(u&&!g.isPrototypeOf(o)){var w=nt(o);He=Se(o,g);try{new g.constructor}finally{He=null,w()}}var b="".concat(u?"":"dis","connectedCallback");b in g&&o[b]()},$t=_e({query:Be,handle:qt}),gt=$t.parse,Gt=_e({query:ht,handle:function(o,u){je.has(o)&&(u?Ve.add(o):Ve.delete(o),Be.length&&dt.call(Be,o))}}),Ut=Gt.parse,bt=Ze.prototype.attachShadow;bt&&(Ze.prototype.attachShadow=function(d){var o=bt.call(this,d);return je.set(this,o),o});var qe=function(o){if(!De.has(o)){var u,m=new Promise(function(g){u=g});De.set(o,{$:m,_:u})}return De.get(o).$},$e=a(qe,Xe),He=null;At(self).filter(function(d){return/^HTML.*Element$/.test(d)}).forEach(function(d){var o=self[d];function u(){var m=this.constructor;if(!Ae.has(m))throw new tt("Illegal constructor");var g=Ae.get(m),w=g.is,b=g.tag;if(w){if(He)return $e(He,w);var v=ut.call(z,b);return v.setAttribute("is",w),$e(Se(v,m.prototype),w)}else return Vt.call(this,o,[],m)}Me(u.prototype=o.prototype,"constructor",{value:u}),Me(self,d,{value:u})}),z.createElement=function(d,o){var u=o&&o.is;if(u){var m=Oe.get(u);if(m&&Ae.get(m).tag===d)return new m}var g=ut.call(z,d);return u&&g.setAttribute("is",u),g},G.get=mt,G.whenDefined=qe,G.upgrade=function(d){var o=d.getAttribute("is");if(o){var u=Oe.get(o);if(u){$e(Se(d,u.prototype),o);return}}Ft.call(G,d)},G.define=function(d,o,u){if(mt(d))throw new et("'".concat(d,"' has already been defined as a custom element"));var m,g=u&&u.extends;Ae.set(o,g?{is:d,tag:g}:{is:"",tag:d}),g?(m="".concat(g,'[is="').concat(d,'"]'),pt.set(m,o.prototype),Oe.set(d,o),Be.push(m)):(Nt.apply(G,arguments),ht.push(m=d)),qe(d).then(function(){g?(gt(z.querySelectorAll(m)),Ve.forEach(dt,[m])):Ut(z.querySelectorAll(m))}),De.get(d)._(o)}}})();var ye=(a=>(a.Default="default",a.Page="page",a.NotFound="not-found",a))(ye||{});class Je{constructor(n,e,t){i(this,"url");i(this,"type");i(this,"routing");this.url=n,this.type=e,this.routing=t}}class Xt extends HTMLElement{constructor(){super();i(this,"shadowRoot");i(this,"routes",[]);this.shadowRoot=this.attachShadow({mode:"closed"})}connectedCallback(){window.addEventListener("hashchange",()=>{this.checkRoute()})}addRoutes(e){this.routes=[...e],this.checkRoute()}checkRoute(){const e=window.location.hash.slice(2);this.changeRoute(e)}changeRoute(e){if(e){const t=this.routes.findIndex(r=>r.url===e);this.shadowRoot.innerHTML=this.routes[t]?this.routes[t].routing():this.sendNotFound()}else{const t=this.routes.filter(r=>r.type===ye.Default);t?window.location.hash="#/"+t[0].url:this.sendNotFound()}}sendNotFound(){const e=this.routes.filter(t=>t.type===ye.NotFound);return e.length===0||(window.location.hash="#/"+e[0].url,this.changeRoute(e[0].url)),"404: Not found"}}customElements.define("app-router",Xt);class ke{constructor(n,e){i(this,"color");i(this,"opacity");this.color=n,this.opacity=e}static createEmpty(){return new ke("#008000",1)}}class Ee{constructor(n,e,t){i(this,"propertyName");i(this,"displayName");i(this,"type");this.propertyName=n,this.displayName=e,this.type=t}static createEmpty(){return new Ee("","","string")}}var ce=(a=>(a.String="string",a.Image="image",a.Number="number",a))(ce||{});class ${constructor(n,e,t,r,s,c){i(this,"name");i(this,"layer");i(this,"url");i(this,"style");i(this,"tags");i(this,"relevantProperties");this.name=n,this.layer=e,this.url=t,this.style=r,this.tags=s,this.relevantProperties=c}static createEmpty(){return new $("","","",ke.createEmpty(),[],[Ee.createEmpty()])}}const U=class U{constructor(){i(this,"CATEGORIES_URL","./json/categories.json");i(this,"_data");if(U._instance)return U._instance;U._instance=this}static get instance(){return U._instance||(U._instance=new U),U._instance}get data(){return this._data}set data(n){this._data=n}async getData(){if(this.data)return this.data;{let n=await this.fetchAppData(this.CATEGORIES_URL);return n=this.parseData(n),this.data=n,n}}async fetchAppData(n){try{const e=await fetch(n).then(r=>r.json()),t=await Promise.all(e.categories.map(async r=>{const s=await Promise.all(r.groups.map(async c=>{if(typeof c=="string")try{const p=await fetch(c);if(p.ok)return p.json();throw new Error("Errore durante il recupero dei dati.")}catch(p){return console.error(p),null}else return c}));return r.groups=s,r}));return{...e,categories:t}}catch(e){throw console.error("Errore durante il recupero dei dati JSON.",e),e}}parseData(n){return{categories:n.categories.map(t=>({name:t.name,groups:t.groups.map(r=>this.parseGroup(r))}))}}parseGroup(n){return Array.isArray(n)?n:{name:n.name,layers:n.layers.map(e=>this.parseLayer(e))}}parseLayer(n){return new $(n.name,n.layer,n.layer_url_wfs,new ke(n.style.color,parseFloat(n.style.opacity)),n.tags,n.relevant_properties.map(e=>{let t=Ee.createEmpty();switch(t.displayName=e.display_name,t.propertyName=e.property_name,e.type){case"image":t.type=ce.Image;break;case"number":t.type=ce.Number;break;default:t.type=ce.String;break}return t}))}getAllLayers(n){const e=[];return n.categories.map(t=>{t.groups.map(r=>{typeof r!="string"&&r.layers.map(s=>{e.push(s)})})}),e}filterLayersByNameAndTag(n,e){let t=[];return t=n.categories.flatMap(r=>r.groups.flatMap(s=>typeof s=="string"?[$.createEmpty()]:s.layers.filter(c=>c.name.toLowerCase().includes(e)||c.tags.some(p=>p.includes(e))))),t}filterLayersByLayerName(n){let e;return this.data.categories.find(t=>t.groups.find(r=>typeof r=="string"?!1:(e=r.layers.find(s=>s.layer.includes(n)),e!==void 0))),e}getAllTags(n){let e=[];return n.categories.map(r=>{r.groups.map(s=>{typeof s!="string"&&s.layers.map(c=>{c.tags.map(p=>{e.push(p)})})})}),[...new Set(e)]}filterLayersByTag(n,e){let t=[];return t=n.categories.flatMap(r=>r.groups.flatMap(s=>typeof s=="string"?[$.createEmpty()]:s.layers.filter(c=>c.tags.some(p=>p.includes(e))))),t}filterLayersByTags(n,e){let t=[];return e.forEach(s=>{this.filterLayersByTag(n,s).forEach(p=>t.push(p))}),[...new Set(t)]}};i(U,"_instance");let j=U;const Kt=`.page {\r
    display: flex;\r
...
\r
    .box {\r
        ...
        min-height: 100dvh;\r
            ...
            `}}customElements.define("page-tags",Zt);const J=class J{constructor(){i(this,"listeners",{});if(J._instance)return J._instance;J._instance=this}static get instance(){return J._instance||(J._instance=new J),J._instance}subscribe(n,e){this.listeners[n]||(this.listeners[n]=[]),this.listeners[n].push(e)}unsubscribe(n,e){this.listeners[n]&&(this.listeners[n]=this.listeners[n].filter(t=>t!==e))}unsubscribeAll(n){delete this.listeners[n]}publish(n,e){this.listeners[n]&&this.listeners[n].forEach(t=>t(e))}};i(J,"_instance");let l=J;const W=class W{constructor(){i(this,"_position",null);i(this,"_watchId",null);if(W._instance)return W._instance;W._instance=this}get position(){return this._position}set position(n){this._position=n,l.instance.publish("set-position",this.position)}get watchId(){return this._watchId}set watchId(n){this._watchId=n}static get instance(){return W._instance||(W._instance=new W),W._instance}async getPosition(){try{return await new Promise((e,t)=>{navigator.geolocation.getCurrentPosition(r=>e(r),r=>t(r))})}catch{return null}}async startWatchingUserPosition(){try{this.watchId=navigator.geolocation.watchPosition(n=>this.position=n,n=>{throw n},{enableHighAccuracy:!0,timeout:5e3,maximumAge:0})}catch{this.position=null}}stopWatchingPosition(){this.watchId&&(navigator.geolocation.clearWatch(this.watchId),this.watchId=null)}static geolocationToCartographic(n){return new Cesium.Cartographic(n.coords.longitude,n.coords.latitude,n.coords.altitude||0)}};i(W,"_instance");let ve=W;class we{constructor(n,e,t,r,s,c,p){i(this,"uuid");i(this,"name");i(this,"position");i(this,"type");i(this,"layer");i(this,"layerName");i(this,"props");this.uuid=n,this.name=e,this.position=t,this.type=r,this.layer=s,this.layerName=c,this.props=p}static createEmpty(){return new we("","",Cesium.Cartographic.ZERO,"point",$.createEmpty(),"",[])}}class Le{constructor(n,e,t){i(this,"displayName");i(this,"type");i(this,"value");this.displayName=n,this.type=e,this.value=t}static createEmpty(){return new Le("",ce.String,"")}}var oe=(a=>(a.Point="point",a.Polyline="polyline",a.Polygon="polygon",a))(oe||{});class F{constructor(n,e,t){i(this,"name");i(this,"pois");i(this,"lastSelected");this.name=n,this.pois=e,this.lastSelected=t}static createEmpty(){return new F("",[],!0)}static createDefault(){return new F("default",[],!0)}}var E=(a=>(a.Info="info",a.SuggestedPath="suggested-path",a.CustomPath="custom-path",a.SelectedSuggestedPath="selected-suggested-path",a))(E||{});const Y=class Y{constructor(){i(this,"_currentTab",E.Info);i(this,"_isSuggestedPathSelected",!1);if(Y._instance)return Y._instance;Y._instance=this}static get instance(){return Y._instance||(Y._instance=new Y),Y._instance}get currentTab(){return this._currentTab}set currentTab(n){this._currentTab=n,l.instance.publish("current-tab-updated",this.currentTab)}get isSuggestedPathSelected(){return this._isSuggestedPathSelected}set isSuggestedPathSelected(n){this._isSuggestedPathSelected=n}};i(Y,"_instance");let le=Y;var T=(a=>(a.Loader="loader",a.Temporary="temporary",a.Error="error",a.Info="info",a))(T||{});const Qt=`:host {\r
    position: relative;\r
    width: 100%;\r
...
.property-value {\r
    color: var(--on-surface);\r
            ...
            <div class="tools"></div>
            `;const e=this.shadowRoot.querySelector(".legend"),t=this.shadowRoot.querySelector(".category"),r=this.shadowRoot.querySelector(".tools");e.style.backgroundColor=S.rgbToRgba(S.hexToRgb(this._poi.layer.style.color),.5),e.style.borderColor=this._poi.layer.style.color,this.poi.props.forEach(y=>{y.displayName==="Nome"?t.innerHTML=y.value:t.innerHTML=this.poi.name});const s=this.renderDirectionsBtn();s&&r.appendChild(s);const c=this.renderAddToRouteBtn();c&&r.append(c);const p=this.renderInfo();p&&this.shadowRoot.appendChild(p)}renderDirectionsBtn(){if(!this.poi)return null;const e=document.createElement("button");return e.classList.add("directions-btn"),e.innerHTML="Indicazioni",e.addEventListener("click",()=>se.instance.openGoogleMaps(this.poi.position)),e}renderAddToRouteBtn(){if(!this.poi||this.poi.type!==oe.Point)return null;const e=document.createElement("button");return e.classList.add("add-to-path-btn"),e.innerHTML="Aggiungi",e.addEventListener("click",()=>{this.poi&&h.instance.addPoiToSelectedPath(this.poi)}),e}renderInfo(){if(!this.poi)return null;const e=this.poi.props.filter(s=>s.displayName!=="Nome");if(e.length===0)return null;let t=document.createElement("div");t.classList.add("info");const r=document.createElement("div");return r.classList.add("info-content"),t.appendChild(r),e.forEach(s=>{const c=this.renderTopic(s);r.appendChild(c)}),t}toggleInfo(){const e=this.shadowRoot.querySelector(".info-content"),t=this.shadowRoot.querySelector(".toggle-info");e&&t&&(this.isInfoOpen?e.classList.add("visible"):e.classList.remove("visible"),this.isInfoOpen?t.innerHTML="Mostra meno":t.innerHTML="Leggi info")}renderTopic(e){const t=document.createElement("div");t.classList.add("property");const r=document.createElement("label");r.classList.add("property-label"),r.innerHTML=e.displayName;const s=document.createElement("p");return s.classList.add("property-value"),e.value!==""?s.innerHTML=e.value:s.innerHTML="-",t.appendChild(r),t.appendChild(s),t}}customElements.define("app-info-panel",Ln);var ie=(a=>(a.SortPois="sort-pois",a.EditPath="edit-path",a.AddPath="add-path",a.BookmarkPath="bookmark-path",a.LoadPath="load-path",a))(ie||{});const ae=class ae{constructor(){ae._instance||(ae._instance=this)}static get instance(){return ae._instance||(ae._instance=new ae),ae._instance}calculateDistance(n,e){const t=n.longitude-e.longitude,r=n.latitude-e.latitude;return Math.sqrt(t*t+r*r)}nearestInsertion(n,e){const t=[...n];let r=0,s=this.calculateDistance(e,t[0].position);for(let p=1;p<t.length;p++){const y=this.calculateDistance(e,t[p].position);y<s&&(s=y,r=p)}const c=[t.splice(r,1)[0]];for(;t.length>0;){s=Number.MAX_VALUE;let p=0;for(let y=0;y<t.length;y++){const x=this.calculateDistance(c[c.length-1].position,t[y].position);x<s&&(s=x,p=y)}c.push(t.splice(p,1)[0])}return c.reverse()}};i(ae,"_instance");let Ue=ae;const En=`.form {\r
    color: var(--on-surface);\r
}\r
\r
h4,\r
...
button.delete-btn {\r
    ...
    border-color: var(--error-container);\r
            ...
            `}setupAddPathForm(){const e=this.shadowRoot.querySelector("input");if(!e)return;const t=this.shadowRoot.querySelector(".submit-btn");if(!t)return;const r=this.shadowRoot.querySelector(".form");if(!r)return;e.value.length===0&&(t.disabled=!0);const s=()=>{t.disabled=e.value.trim().length===0||h.instance.paths.some(c=>c.name===e.value.toLowerCase())};e.addEventListener("input",s),e.addEventListener("change",s),r.addEventListener("submit",()=>h.instance.saveNewPath(e.value))}renderBookmarkPathForm(){var e;this.shadowRoot.innerHTML=`
            <form class="form">
...
.tool-icon {\r
    font-size: 1rem;\r
            ...
            `}setup(){const e=this.shadowRoot.querySelector(".sort-btn"),t=this.shadowRoot.querySelector(".edit-btn"),r=this.shadowRoot.querySelector(".add-btn"),s=this.shadowRoot.querySelector(".bookmark-btn"),c=this.shadowRoot.querySelector(".load-btn"),p=this.shadowRoot.querySelector('button[is="app-custom-path-download-btn"]');e&&e.addEventListener("click",()=>me.instance.createFormDialog(ie.SortPois)),t&&t.addEventListener("click",()=>me.instance.createFormDialog(ie.EditPath)),r&&r.addEventListener("click",()=>me.instance.createFormDialog(ie.AddPath)),s&&s.addEventListener("click",()=>me.instance.createFormDialog(ie.BookmarkPath)),c&&c.addEventListener("click",()=>me.instance.createFormDialog(ie.LoadPath)),p&&(p.path={...this.path}),l.instance.subscribe("selected-custom-path-updated",y=>{this.path=y})}update(){const e=this.shadowRoot.querySelector(".list");if(!e)return;e.innerHTML="",this.path.pois.forEach(r=>{let s=new Pt;s.poi=r,e.appendChild(s)});const t=this.shadowRoot.querySelector(".edit-btn");t&&this.path.name==="default"&&(t.disabled=!0)}disconnectedCallback(){l.instance.unsubscribeAll("selected-custom-path-updated")}}customElements.define("app-custom-path-panel",Mn);class Rn extends HTMLButtonElement{constructor(){super();i(this,"_isOpen",!1)}get isOpen(){return this._isOpen}set isOpen(e){this._isOpen=e,this.isOpen===!0?this.classList.add("open"):this.classList.remove("open")}connectedCallback(){this.setup()}setup(){this.addEventListener("click",()=>ge.instance.togglePhysicalMap()),l.instance.subscribe("toggle-tabs",e=>{this.isOpen=e})}disconnectedCallback(){l.instance.unsubscribeAll("toggle-tabs")}}customElements.define("app-map-type-btn",Rn,{extends:"button"});const In=`:host {\r
    position: fixed;\r
    bottom: 24px;\r
    right: 24px;\r
    display: flex;\r
...
`;return Object.keys(this.path).forEach(t=>{t==="pois"&&this.path.pois.forEach(r=>{const s=r.props.map(p=>`${p.displayName}: ${p.value}`).join("|"),c=`${this.path.name}	${r.layerName}	${r.uuid}	${r.name}	${Cesium.Math.toDegrees(r.position.latitude)}	${Cesium.Math.toDegrees(r.position.longitude)}	${Cesium.Math.toDegrees(r.position.height)}	${s}
`;e+=c})}),e.endsWith(`
