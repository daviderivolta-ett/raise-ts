var Yn=Object.defineProperty;var Xn=(c,t,e)=>t in c?Yn(c,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):c[t]=e;var i=(c,t,e)=>(Xn(c,typeof t!="symbol"?t+"":t,e),e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function e(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(r){if(r.ep)return;r.ep=!0;const s=e(r);fetch(r.href,s)}})();/*! (c) Andrea Giammarchi @webreflection ISC */(function(){var c=function(d,a){var u=function(w){for(var b=0,v=w.length;b<v;b++)m(w[b])},m=function(w){var b=w.target,v=w.attributeName,P=w.oldValue;b.attributeChangedCallback(v,P,b.getAttribute(v))};return function(g,w){var b=g.constructor.observedAttributes;return b&&d(w).then(function(){new a(u).observe(g,{attributes:!0,attributeOldValue:!0,attributeFilter:b});for(var v=0,P=b.length;v<P;v++)g.hasAttribute(b[v])&&m({target:g,attributeName:b[v],oldValue:null})}),g}};function t(d,a){if(d){if(typeof d=="string")return e(d,a);var u=Object.prototype.toString.call(d).slice(8,-1);if(u==="Object"&&d.constructor&&(u=d.constructor.name),u==="Map"||u==="Set")return Array.from(d);if(u==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(u))return e(d,a)}}function e(d,a){(a==null||a>d.length)&&(a=d.length);for(var u=0,m=new Array(a);u<a;u++)m[u]=d[u];return m}function n(d,a){var u=typeof Symbol<"u"&&d[Symbol.iterator]||d["@@iterator"];if(!u){if(Array.isArray(d)||(u=t(d))||a&&d&&typeof d.length=="number"){u&&(d=u);var m=0,g=function(){};return{s:g,n:function(){return m>=d.length?{done:!0}:{done:!1,value:d[m++]}},e:function(P){throw P},f:g}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var w=!0,b=!1,v;return{s:function(){u=u.call(d)},n:function(){var P=u.next();return w=P.done,P},e:function(P){b=!0,v=P},f:function(){try{!w&&u.return!=null&&u.return()}finally{if(b)throw v}}}}/*! (c) Andrea Giammarchi - ISC */var r=!0,s=!1,o="querySelectorAll",p=function(a){var u=arguments.length>1&&arguments[1]!==void 0?arguments[1]:document,m=arguments.length>2&&arguments[2]!==void 0?arguments[2]:MutationObserver,g=arguments.length>3&&arguments[3]!==void 0?arguments[3]:["*"],w=function P(he,me,D,f,k,C){var O=n(he),fe;try{for(O.s();!(fe=O.n()).done;){var R=fe.value;(C||o in R)&&(k?D.has(R)||(D.add(R),f.delete(R),a(R,k)):f.has(R)||(f.add(R),D.delete(R),a(R,k)),C||P(R[o](me),me,D,f,k,r))}}catch(Ge){O.e(Ge)}finally{O.f()}},b=new m(function(P){if(g.length){var he=g.join(","),me=new Set,D=new Set,f=n(P),k;try{for(f.s();!(k=f.n()).done;){var C=k.value,O=C.addedNodes,fe=C.removedNodes;w(fe,he,me,D,s,s),w(O,he,me,D,r,s)}}catch(R){f.e(R)}finally{f.f()}}}),v=b.observe;return(b.observe=function(P){return v.call(b,P,{subtree:r,childList:r})})(u),b},y="querySelectorAll",x=self,I=x.document,H=x.Element,A=x.MutationObserver,_=x.Set,q=x.WeakMap,Je=function(a){return y in a},Ye=[].filter,_e=function(d){var a=new q,u=function(f){for(var k=0,C=f.length;k<C;k++)a.delete(f[k])},m=function(){for(var f=he.takeRecords(),k=0,C=f.length;k<C;k++)b(Ye.call(f[k].removedNodes,Je),!1),b(Ye.call(f[k].addedNodes,Je),!0)},g=function(f){return f.matches||f.webkitMatchesSelector||f.msMatchesSelector},w=function(f,k){var C;if(k)for(var O,fe=g(f),R=0,Ge=v.length;R<Ge;R++)fe.call(f,O=v[R])&&(a.has(f)||a.set(f,new _),C=a.get(f),C.has(O)||(C.add(O),d.handle(f,k,O)));else a.has(f)&&(C=a.get(f),a.delete(f),C.forEach(function(Jn){d.handle(f,k,Jn)}))},b=function(f){for(var k=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!0,C=0,O=f.length;C<O;C++)w(f[C],k)},v=d.query,P=d.root||I,he=p(w,P,A,v),me=H.prototype.attachShadow;return me&&(H.prototype.attachShadow=function(D){var f=me.call(this,D);return he.observe(f),f}),v.length&&b(P[y](v)),{drop:u,flush:m,observer:he,parse:b}},N=self,z=N.document,pe=N.Map,Xe=N.MutationObserver,Te=N.Object,Ke=N.Set,Mn=N.WeakMap,Ze=N.Element,Rn=N.HTMLElement,Qe=N.Node,en=N.Error,nn=N.TypeError,In=N.Reflect,Me=Te.defineProperty,An=Te.keys,Dn=Te.getOwnPropertyNames,Se=Te.setPrototypeOf,Pe=!self.customElements,tn=function(a){for(var u=An(a),m=[],g=new Ke,w=u.length,b=0;b<w;b++){m[b]=a[u[b]];try{delete a[u[b]]}catch{g.add(b)}}return function(){for(var v=0;v<w;v++)g.has(v)||(a[u[v]]=m[v])}};if(Pe){var Ne=function(){var a=this.constructor;if(!ze.has(a))throw new nn("Illegal constructor");var u=ze.get(a);if(Ie)return an(Ie,u);var m=rn.call(z,u);return an(Se(m,a.prototype),u)},rn=z.createElement,ze=new pe,Re=new pe,sn=new pe,Ce=new pe,on=[],On=function(a,u,m){var g=sn.get(m);if(u&&!g.isPrototypeOf(a)){var w=tn(a);Ie=Se(a,g);try{new g.constructor}finally{Ie=null,w()}}var b="".concat(u?"":"dis","connectedCallback");b in g&&a[b]()},Bn=_e({query:on,handle:On}),Hn=Bn.parse,Ie=null,Fe=function(a){if(!Re.has(a)){var u,m=new Promise(function(g){u=g});Re.set(a,{$:m,_:u})}return Re.get(a).$},an=c(Fe,Xe);self.customElements={define:function(a,u){if(Ce.has(a))throw new en('the name "'.concat(a,'" has already been used with this registry'));ze.set(u,a),sn.set(a,u.prototype),Ce.set(a,u),on.push(a),Fe(a).then(function(){Hn(z.querySelectorAll(a))}),Re.get(a)._(u)},get:function(a){return Ce.get(a)},whenDefined:Fe},Me(Ne.prototype=Rn.prototype,"constructor",{value:Ne}),self.HTMLElement=Ne,z.createElement=function(d,a){var u=a&&a.is,m=u?Ce.get(u):Ce.get(d);return m?new m:rn.call(z,d)},"isConnected"in Qe.prototype||Me(Qe.prototype,"isConnected",{configurable:!0,get:function(){return!(this.ownerDocument.compareDocumentPosition(this)&this.DOCUMENT_POSITION_DISCONNECTED)}})}else if(Pe=!self.customElements.get("extends-br"),Pe)try{var cn=function d(){return self.Reflect.construct(HTMLBRElement,[],d)};cn.prototype=HTMLLIElement.prototype;var ln="extends-br";self.customElements.define("extends-br",cn,{extends:"br"}),Pe=z.createElement("br",{is:ln}).outerHTML.indexOf(ln)<0;var dn=self.customElements,_n=dn.get,Nn=dn.whenDefined;self.customElements.whenDefined=function(d){var a=this;return Nn.call(this,d).then(function(u){return u||_n.call(a,d)})}}catch{}if(Pe){var un=function(a){var u=je.get(a);bn(u.querySelectorAll(this),a.isConnected)},G=self.customElements,pn=z.createElement,zn=G.define,Fn=G.get,jn=G.upgrade,qn=In||{construct:function(a){return a.call(this)}},Vn=qn.construct,je=new Mn,qe=new Ke,Ae=new pe,De=new pe,hn=new pe,Oe=new pe,mn=[],Be=[],gn=function(a){return Oe.get(a)||Fn.call(G,a)},$n=function(a,u,m){var g=hn.get(m);if(u&&!g.isPrototypeOf(a)){var w=tn(a);He=Se(a,g);try{new g.constructor}finally{He=null,w()}}var b="".concat(u?"":"dis","connectedCallback");b in g&&a[b]()},Gn=_e({query:Be,handle:$n}),bn=Gn.parse,Un=_e({query:mn,handle:function(a,u){je.has(a)&&(u?qe.add(a):qe.delete(a),Be.length&&un.call(Be,a))}}),Wn=Un.parse,fn=Ze.prototype.attachShadow;fn&&(Ze.prototype.attachShadow=function(d){var a=fn.call(this,d);return je.set(this,a),a});var Ve=function(a){if(!De.has(a)){var u,m=new Promise(function(g){u=g});De.set(a,{$:m,_:u})}return De.get(a).$},$e=c(Ve,Xe),He=null;Dn(self).filter(function(d){return/^HTML.*Element$/.test(d)}).forEach(function(d){var a=self[d];function u(){var m=this.constructor;if(!Ae.has(m))throw new nn("Illegal constructor");var g=Ae.get(m),w=g.is,b=g.tag;if(w){if(He)return $e(He,w);var v=pn.call(z,b);return v.setAttribute("is",w),$e(Se(v,m.prototype),w)}else return Vn.call(this,a,[],m)}Me(u.prototype=a.prototype,"constructor",{value:u}),Me(self,d,{value:u})}),z.createElement=function(d,a){var u=a&&a.is;if(u){var m=Oe.get(u);if(m&&Ae.get(m).tag===d)return new m}var g=pn.call(z,d);return u&&g.setAttribute("is",u),g},G.get=gn,G.whenDefined=Ve,G.upgrade=function(d){var a=d.getAttribute("is");if(a){var u=Oe.get(a);if(u){$e(Se(d,u.prototype),a);return}}jn.call(G,d)},G.define=function(d,a,u){if(gn(d))throw new en("'".concat(d,"' has already been defined as a custom element"));var m,g=u&&u.extends;Ae.set(a,g?{is:d,tag:g}:{is:"",tag:d}),g?(m="".concat(g,'[is="').concat(d,'"]'),hn.set(m,a.prototype),Oe.set(d,a),Be.push(m)):(zn.apply(G,arguments),mn.push(m=d)),Ve(d).then(function(){g?(bn(z.querySelectorAll(m)),qe.forEach(un,[m])):Wn(z.querySelectorAll(m))}),De.get(d)._(a)}}})();var ve=(c=>(c.Default="default",c.Page="page",c.NotFound="not-found",c))(ve||{});class We{constructor(t,e,n){i(this,"url");i(this,"type");i(this,"routing");this.url=t,this.type=e,this.routing=n}}class Kn extends HTMLElement{constructor(){super();i(this,"shadowRoot");i(this,"routes",[]);this.shadowRoot=this.attachShadow({mode:"closed"})}connectedCallback(){window.addEventListener("hashchange",()=>{this.checkRoute()})}addRoutes(e){this.routes=[...e],this.checkRoute()}checkRoute(){const e=window.location.hash.slice(2);this.changeRoute(e)}changeRoute(e){if(e){const n=this.routes.findIndex(r=>r.url===e);this.shadowRoot.innerHTML=this.routes[n]?this.routes[n].routing():this.sendNotFound()}else{const n=this.routes.filter(r=>r.type===ve.Default);n?window.location.hash="#/"+n[0].url:this.sendNotFound()}}sendNotFound(){const e=this.routes.filter(n=>n.type===ve.NotFound);return e.length===0||(window.location.hash="#/"+e[0].url,this.changeRoute(e[0].url)),"404: Not found"}}customElements.define("app-router",Kn);class ke{constructor(t,e){i(this,"color");i(this,"opacity");this.color=t,this.opacity=e}static createEmpty(){return new ke("#008000",1)}}class Ee{constructor(t,e,n){i(this,"propertyName");i(this,"displayName");i(this,"type");this.propertyName=t,this.displayName=e,this.type=n}static createEmpty(){return new Ee("","","string")}}var de=(c=>(c.String="string",c.Image="image",c.Number="number",c))(de||{});class ${constructor(t,e,n,r,s,o){i(this,"name");i(this,"layer");i(this,"url");i(this,"style");i(this,"tags");i(this,"relevantProperties");this.name=t,this.layer=e,this.url=n,this.style=r,this.tags=s,this.relevantProperties=o}static createEmpty(){return new $("","","",ke.createEmpty(),[],[Ee.createEmpty()])}}const U=class U{constructor(){i(this,"CATEGORIES_URL","./json/categories.json");i(this,"_data");if(U._instance)return U._instance;U._instance=this}static get instance(){return U._instance||(U._instance=new U),U._instance}get data(){return this._data}set data(t){this._data=t}async getData(){if(this.data)return this.data;{let t=await this.fetchAppData(this.CATEGORIES_URL);return t=this.parseData(t),this.data=t,t}}async fetchAppData(t){try{const e=await fetch(t).then(r=>r.json()),n=await Promise.all(e.categories.map(async r=>{const s=await Promise.all(r.groups.map(async o=>{if(typeof o=="string")try{const p=await fetch(o);if(p.ok)return p.json();throw new Error("Errore durante il recupero dei dati.")}catch(p){return console.error(p),null}else return o}));return r.groups=s,r}));return{...e,categories:n}}catch(e){throw console.error("Errore durante il recupero dei dati JSON.",e),e}}parseData(t){return{categories:t.categories.map(n=>({name:n.name,groups:n.groups.map(r=>this.parseGroup(r))}))}}parseGroup(t){return Array.isArray(t)?t:{name:t.name,layers:t.layers.map(e=>this.parseLayer(e))}}parseLayer(t){return new $(t.name,t.layer,t.layer_url_wfs,new ke(t.style.color,parseFloat(t.style.opacity)),t.tags,t.relevant_properties.map(e=>{let n=Ee.createEmpty();switch(n.displayName=e.display_name,n.propertyName=e.property_name,e.type){case"image":n.type=de.Image;break;case"number":n.type=de.Number;break;default:n.type=de.String;break}return n}))}getAllLayers(t){const e=[];return t.categories.map(n=>{n.groups.map(r=>{typeof r!="string"&&r.layers.map(s=>{e.push(s)})})}),e}filterLayersByNameAndTag(t,e){let n=[];return n=t.categories.flatMap(r=>r.groups.flatMap(s=>typeof s=="string"?[$.createEmpty()]:s.layers.filter(o=>o.name.toLowerCase().includes(e)||o.tags.some(p=>p.includes(e))))),n}filterLayersByLayerName(t){let e;return this.data.categories.find(n=>n.groups.find(r=>typeof r=="string"?!1:(e=r.layers.find(s=>s.layer.includes(t)),e!==void 0))),e}getAllTags(t){let e=[];return t.categories.map(r=>{r.groups.map(s=>{typeof s!="string"&&s.layers.map(o=>{o.tags.map(p=>{e.push(p)})})})}),[...new Set(e)]}filterLayersByTag(t,e){let n=[];return n=t.categories.flatMap(r=>r.groups.flatMap(s=>typeof s=="string"?[$.createEmpty()]:s.layers.filter(o=>o.tags.some(p=>p.includes(e))))),n}filterLayersByTags(t,e){let n=[];return e.forEach(s=>{this.filterLayersByTag(t,s).forEach(p=>n.push(p))}),[...new Set(n)]}};i(U,"_instance");let j=U;const Zn=`// .page {\r
//     display: flex;\r
...
.box {\r
    ...
    margin: auto;\r
            ...
            `}}customElements.define("page-tags",Qn);const W=class W{constructor(){i(this,"listeners",{});if(W._instance)return W._instance;W._instance=this}static get instance(){return W._instance||(W._instance=new W),W._instance}subscribe(t,e){this.listeners[t]||(this.listeners[t]=[]),this.listeners[t].push(e)}unsubscribe(t,e){this.listeners[t]&&(this.listeners[t]=this.listeners[t].filter(n=>n!==e))}unsubscribeAll(t){delete this.listeners[t]}publish(t,e){this.listeners[t]&&this.listeners[t].forEach(n=>n(e))}};i(W,"_instance");let l=W;const J=class J{constructor(){i(this,"_position",null);i(this,"_watchId",null);if(J._instance)return J._instance;J._instance=this}get position(){return this._position}set position(t){this._position=t,l.instance.publish("set-position",this.position)}get watchId(){return this._watchId}set watchId(t){this._watchId=t}static get instance(){return J._instance||(J._instance=new J),J._instance}async getPosition(){try{return await new Promise((e,n)=>{navigator.geolocation.getCurrentPosition(r=>e(r),r=>n(r))})}catch{return null}}async startWatchingUserPosition(){try{this.watchId=navigator.geolocation.watchPosition(t=>this.position=t,t=>{throw t},{enableHighAccuracy:!0,timeout:5e3,maximumAge:0})}catch{this.position=null}}stopWatchingPosition(){this.watchId&&(navigator.geolocation.clearWatch(this.watchId),this.watchId=null)}static geolocationToCartographic(t){return new Cesium.Cartographic(t.coords.longitude,t.coords.latitude,t.coords.altitude||0)}};i(J,"_instance");let be=J;class we{constructor(t,e,n,r,s,o,p){i(this,"uuid");i(this,"name");i(this,"position");i(this,"type");i(this,"layer");i(this,"layerName");i(this,"props");this.uuid=t,this.name=e,this.position=n,this.type=r,this.layer=s,this.layerName=o,this.props=p}static createEmpty(){return new we("","",Cesium.Cartographic.ZERO,"point",$.createEmpty(),"",[])}}class Le{constructor(t,e,n){i(this,"displayName");i(this,"type");i(this,"value");this.displayName=t,this.type=e,this.value=n}static createEmpty(){return new Le("",de.String,"")}}var oe=(c=>(c.Point="point",c.Polyline="polyline",c.Polygon="polygon",c))(oe||{});class F{constructor(t,e,n){i(this,"name");i(this,"pois");i(this,"lastSelected");this.name=t,this.pois=e,this.lastSelected=n}static createEmpty(){return new F("",[],!0)}static createDefault(){return new F("default",[],!0)}}var E=(c=>(c.Info="info",c.SuggestedPath="suggested-path",c.CustomPath="custom-path",c.SelectedSuggestedPath="selected-suggested-path",c))(E||{});const Y=class Y{constructor(){i(this,"_currentTab",E.Info);i(this,"_isSuggestedPathSelected",!1);if(Y._instance)return Y._instance;Y._instance=this}static get instance(){return Y._instance||(Y._instance=new Y),Y._instance}get currentTab(){return this._currentTab}set currentTab(t){this._currentTab=t,l.instance.publish("current-tab-updated",this.currentTab)}get isSuggestedPathSelected(){return this._isSuggestedPathSelected}set isSuggestedPathSelected(t){this._isSuggestedPathSelected=t}};i(Y,"_instance");let ue=Y;var T=(c=>(c.Loader="loader",c.Temporary="temporary",c.Error="error",c.Info="info",c))(T||{});const et=`:host {\r
    position: relative;\r
    width: 100%;\r
...
\r
    ...
    //     left: 0;\r
    // }\r
}`;class it extends HTMLElement{constructor(){super();i(this,"shadowRoot");i(this,"map",new vn);this.shadowRoot=this.attachShadow({mode:"closed"});let e=new CSSStyleSheet;e.replaceSync(st),this.shadowRoot.adoptedStyleSheets.push(e)}async connectedCallback(){const e=document.createElement("app-splash");document.body.append(e),await j.instance.getData(),await be.instance.startWatchingUserPosition(),h.instance.paths.some(r=>r.name==="default")||h.instance.saveNewPath("default");const n=h.instance.paths.find(r=>r.lastSelected===!0);n&&(h.instance.selectedCustomPath={...n}),this.render(),this.setup(),setTimeout(()=>e.remove(),500)}render(){this.shadowRoot.innerHTML=`
            <div class="page">
                <app-map></app-map>
                <div class="header">
                    <div class="search">
...
.property-value {\r
    color: var(--on-surface);\r
}`;class Lt extends HTMLElement{constructor(){super();i(this,"shadowRoot");i(this,"_poi",V.instance.selectedPoi);i(this,"_isInfoOpen",!1);this.shadowRoot=this.attachShadow({mode:"closed"});let e=new CSSStyleSheet;e.replaceSync(Ct),this.shadowRoot.adoptedStyleSheets.push(e)}get poi(){return this._poi}set poi(e){this._poi=e,this.isInfoOpen=!1,this.update()}get isInfoOpen(){return this._isInfoOpen}set isInfoOpen(e){this._isInfoOpen=e,this.toggleInfo()}connectedCallback(){this.render(),this.setup(),this.poi&&this.update()}disconnectedCallback(){l.instance.unsubscribe("selected-poi",this.handleSelectedPoi.bind(this))}handleSelectedPoi(e){this.poi=e}render(){this.shadowRoot.innerHTML='<p class="empty-msg">Nessun punto selezionato</p>'}setup(){this.handleSelectedPoi=this.handleSelectedPoi.bind(this),l.instance.subscribe("selected-poi",this.handleSelectedPoi)}update(){if(!this.poi){this.render();return}this.shadowRoot.innerHTML=`
            <div class="header">
                <div class="title">
                    <span class="legend"></span>
            ...
            <div class="tools"></div>
            `;const e=this.shadowRoot.querySelector(".legend"),n=this.shadowRoot.querySelector(".category"),r=this.shadowRoot.querySelector(".tools");e.style.backgroundColor=S.rgbToRgba(S.hexToRgb(this._poi.layer.style.color),.5),e.style.borderColor=this._poi.layer.style.color,this.poi.props.forEach(y=>{y.displayName==="Nome"?n.innerHTML=y.value:n.innerHTML=this.poi.name});const s=this.renderDirectionsBtn();s&&r.appendChild(s);const o=this.renderAddToRouteBtn();o&&r.append(o);const p=this.renderInfo();p&&this.shadowRoot.appendChild(p)}renderDirectionsBtn(){if(!this.poi)return null;const e=document.createElement("button");return e.classList.add("directions-btn"),e.innerHTML="Indicazioni",e.addEventListener("click",()=>se.instance.openGoogleMaps(this.poi.position)),e}renderAddToRouteBtn(){if(!this.poi||this.poi.type!==oe.Point)return null;const e=document.createElement("button");return e.classList.add("add-to-path-btn"),e.innerHTML="Aggiungi",e.addEventListener("click",()=>{this.poi&&h.instance.addPoiToSelectedPath(this.poi)}),e}renderInfo(){if(!this.poi)return null;const e=this.poi.props.filter(s=>s.displayName!=="Nome");if(e.length===0)return null;let n=document.createElement("div");n.classList.add("info");const r=document.createElement("div");return r.classList.add("info-content"),n.appendChild(r),e.forEach(s=>{const o=this.renderTopic(s);r.appendChild(o)}),n}toggleInfo(){const e=this.shadowRoot.querySelector(".info-content"),n=this.shadowRoot.querySelector(".toggle-info");e&&n&&(this.isInfoOpen?e.classList.add("visible"):e.classList.remove("visible"),this.isInfoOpen?n.innerHTML="Mostra meno":n.innerHTML="Leggi info")}renderTopic(e){const n=document.createElement("div");n.classList.add("property");const r=document.createElement("label");r.classList.add("property-label"),r.innerHTML=e.displayName;const s=document.createElement("p");return s.classList.add("property-value"),e.value!==""?s.innerHTML=e.value:s.innerHTML="-",n.appendChild(r),n.appendChild(s),n}}customElements.define("app-info-panel",Lt);var ie=(c=>(c.SortPois="sort-pois",c.EditPath="edit-path",c.AddPath="add-path",c.BookmarkPath="bookmark-path",c.LoadPath="load-path",c))(ie||{});const le=class le{constructor(){le._instance||(le._instance=this)}static get instance(){return le._instance||(le._instance=new le),le._instance}calculateDistance(t,e){const n=t.longitude-e.longitude,r=t.latitude-e.latitude;return Math.sqrt(n*n+r*r)}nearestInsertion(t,e){const n=[...t];let r=0,s=this.calculateDistance(e,n[0].position);for(let p=1;p<n.length;p++){const y=this.calculateDistance(e,n[p].position);y<s&&(s=y,r=p)}const o=[n.splice(r,1)[0]];for(;n.length>0;){s=Number.MAX_VALUE;let p=0;for(let y=0;y<n.length;y++){const x=this.calculateDistance(o[o.length-1].position,n[y].position);x<s&&(s=x,p=y)}o.push(n.splice(p,1)[0])}return o.reverse()}};i(le,"_instance");let Ue=le;const Et=`.form {\r
    color: var(--on-surface);\r
}\r
\r
h4,\r
...
button.delete-btn {\r
    ...
    border-color: var(--error-container);\r
            ...
            `}setupSortPoisForm(){const e=this.shadowRoot.querySelector(".form");e&&e.addEventListener("submit",()=>{const n=be.instance.position;if(!n)return;const r=be.geolocationToCartographic(n),s=Ue.instance.nearestInsertion(h.instance.selectedCustomPath.pois,r),o=h.instance.selectedCustomPath;o.pois=s,h.instance.selectedCustomPath=o})}renderEditPathForm(){this.shadowRoot.innerHTML=`
            <form class="form">
            ...
            `}setupEditPathForm(){const e=this.shadowRoot.querySelector("input");if(!e)return;const n=this.shadowRoot.querySelector(".delete-btn");if(!n)return;const r=this.shadowRoot.querySelector(".submit-btn");if(!r)return;const s=this.shadowRoot.querySelector(".form");if(!s)return;e.value=h.instance.selectedCustomPath.name;const o=()=>r.disabled=e.value.trim().length===0||h.instance.paths.some(p=>p.name===e.value.toLowerCase());e.addEventListener("input",o),e.addEventListener("change",o),s.addEventListener("submit",()=>{const y=new FormData(s).get("path-name");y&&h.instance.editPath(y.toString())}),n.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("close-dialog")),h.instance.deletePath()})}renderAddPathForm(){this.shadowRoot.innerHTML=`
            <form class="form">
            ...
            `}setupAddPathForm(){const e=this.shadowRoot.querySelector("input");if(!e)return;const n=this.shadowRoot.querySelector(".submit-btn");if(!n)return;const r=this.shadowRoot.querySelector(".form");if(!r)return;e.value.length===0&&(n.disabled=!0);const s=()=>{n.disabled=e.value.trim().length===0||h.instance.paths.some(o=>o.name===e.value.toLowerCase())};e.addEventListener("input",s),e.addEventListener("change",s),r.addEventListener("submit",()=>h.instance.saveNewPath(e.value))}renderBookmarkPathForm(){var e;this.shadowRoot.innerHTML=`
            <form class="form">
...
.tool-icon {\r
    font-size: 1.25rem;\r
            ...
            `}setup(){const e=this.shadowRoot.querySelector(".sort-btn"),n=this.shadowRoot.querySelector(".edit-btn"),r=this.shadowRoot.querySelector(".add-btn"),s=this.shadowRoot.querySelector(".bookmark-btn"),o=this.shadowRoot.querySelector(".load-btn"),p=this.shadowRoot.querySelector('button[is="app-custom-path-download-btn"]');e&&e.addEventListener("click",()=>ge.instance.createFormDialog(ie.SortPois)),n&&n.addEventListener("click",()=>ge.instance.createFormDialog(ie.EditPath)),r&&r.addEventListener("click",()=>ge.instance.createFormDialog(ie.AddPath)),s&&s.addEventListener("click",()=>ge.instance.createFormDialog(ie.BookmarkPath)),o&&o.addEventListener("click",()=>ge.instance.createFormDialog(ie.LoadPath)),p&&(p.path={...this.path}),l.instance.subscribe("selected-custom-path-updated",y=>{this.path=y})}update(){const e=this.shadowRoot.querySelector(".list");if(!e)return;e.innerHTML="",this.path.pois.forEach(r=>{let s=new Cn;s.poi=r,e.appendChild(s)});const n=this.shadowRoot.querySelector(".edit-btn");n&&this.path.name==="default"&&(n.disabled=!0)}disconnectedCallback(){l.instance.unsubscribeAll("selected-custom-path-updated")}}customElements.define("app-custom-path-panel",Mt);class Rt extends HTMLButtonElement{constructor(){super();i(this,"_isOpen",!1)}get isOpen(){return this._isOpen}set isOpen(e){this._isOpen=e,this.isOpen===!0?this.classList.add("open"):this.classList.remove("open")}connectedCallback(){this.setup()}setup(){this.addEventListener("click",()=>ae.instance.togglePhysicalMap()),l.instance.subscribe("toggle-tabs",e=>{this.isOpen=e})}disconnectedCallback(){l.instance.unsubscribeAll("toggle-tabs")}}customElements.define("app-map-type-btn",Rt,{extends:"button"});const It=`:host {\r
    position: fixed;\r
    bottom: 24px;\r
    right: 24px;\r
    display: flex;\r
...
\r
    &:hover {\r
        opacity: 0.8;\r
...
}`;class Ot extends HTMLElement{constructor(){super();i(this,"shadowRoot");i(this,"_tags",[]);this.shadowRoot=this.attachShadow({mode:"closed"});const e=new CSSStyleSheet;e.replaceSync(Dt),this.shadowRoot.adoptedStyleSheets.push(e)}get tags(){return this._tags}set tags(e){this._tags=e}connectedCallback(){let e=this.chooseLogoColor();this.tags=j.instance.getAllTags(j.instance.data),this.render(e),this.setup()}render(e){this.shadowRoot.innerHTML=`
            ...
            `;const n=this.shadowRoot.querySelector("svg");if(!n)return;const r=n.querySelector(".cls-2");if(!r)return;e==="dark"?r.style.fill="#fff":r.style.fill="#0A0B29";const s=this.shadowRoot.querySelector(".tags-wall");s&&this.tags.forEach(o=>{let p=this.createChip(o);s.append(p)})}setup(){const e=this.shadowRoot.querySelector("form");e&&e.addEventListener("submit",n=>{n.preventDefault();const r=new FormData(e),s=Array.from(r.getAll("tag"),p=>String(p));h.instance.setTags(s);const o=j.instance.filterLayersByTags(j.instance.data,s);h.instance.activeLayers=o,h.instance.benchLayers=[],window.location.hash="/map"})}createChip(e){let n=document.createElement("div");n.classList.add("chip");let r=document.createElement("input");r.type="checkbox",r.id=e.replace(" ","").toLowerCase(),r.name="tag",r.value=e,h.instance.tags.forEach(o=>{o===e&&(r.checked=!0)});let s=document.createElement("label");return s.setAttribute("for",e.replace(" ","").toLowerCase()),s.innerHTML=e.charAt(0).toUpperCase()+e.slice(1),n.append(r),n.append(s),n}chooseLogoColor(){return document.body.classList.contains("dark")?"dark":"light"}}customElements.define("app-tags-wall",Ot);const Bt=`:host {\r
    position: fixed;\r
    top: 0;\r
    left: 0;\r
    height: 100dvh;\r
...
\r
    100% {\r
        clip-path: polygon(50% 50%, 0 0, 100% 0, 100% 100%, 0 100%, 0 0)\r
...
}`;class Ht extends HTMLElement{constructor(){super();i(this,"shadowRoot");this.shadowRoot=this.attachShadow({mode:"closed"});const e=new CSSStyleSheet;e.replaceSync(Bt),this.shadowRoot.adoptedStyleSheets.push(e)}connectedCallback(){let e=this.chooseLogoColor();this.render(e)}render(e){this.shadowRoot.innerHTML=`
            <svg id="Livello_1" data-name="Livello 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="logo">
                <defs>
                    <style>
                    .cls-1 {
            ...
            `;const n=this.shadowRoot.querySelector("svg");if(!n)return;const r=n.querySelector(".cls-2");r&&(e==="dark"?r.style.fill="#fff":r.style.fill="#0A0B29")}chooseLogoColor(){return document.body.classList.contains("dark")?"dark":"light"}}customElements.define("app-splash",Ht);class _t extends HTMLButtonElement{constructor(){super();i(this,"_path",F.createEmpty())}get path(){return this._path}set path(e){this._path=e}connectedCallback(){this.setup()}setup(){this.addEventListener("click",()=>this.downloadCsv())}createCsvContent(){let e=`path	layer name	id	name	latitude	longitude	height	info
`;return Object.keys(this.path).forEach(n=>{n==="pois"&&this.path.pois.forEach(r=>{const s=r.props.map(p=>`${p.displayName}: ${p.value}`).join("|"),o=`${this.path.name}	${r.layerName}	${r.uuid}	${r.name}	${Cesium.Math.toDegrees(r.position.latitude)}	${Cesium.Math.toDegrees(r.position.longitude)}	${Cesium.Math.toDegrees(r.position.height)}	${s}
`;e+=o})}),e.endsWith(`
...
.path-steps {
    ...
    color: var(--on-surface-variant);
            ...
            `,this.shadowRoot.appendChild(this._template.content.cloneNode(!0))}get path(){return this._path}set path(e){this._path=e,this.update()}connectedCallback(){this.render(),this.setup()}render(){}setup(){this.addEventListener("click",()=>{ue.instance.isSuggestedPathSelected=!0,h.instance.selectedSuggestedPath=this.path})}update(){this.path&&(this.innerHTML=`
...
.category {
    ...
    padding: 0 0 0 22px;
            ...
            <p class="category"></p>
            `}update(){if(!this.poi)return;const e=this.shadowRoot.querySelector(".name");e&&(e.innerHTML=this.poi.name);const n=this.shadowRoot.querySelector(".legend");n&&(n.style.backgroundColor=S.rgbToRgba(S.hexToRgb(this.poi.layer.style.color),.5),n.style.borderColor=this.poi.layer.style.color);const r=this.shadowRoot.querySelector(".category");r&&this.poi.props.forEach(s=>{s.displayName==="Nome"?r.innerHTML=s.value:r.innerHTML=this.poi.name})}setup(){this.poi&&this.addEventListener("click",()=>V.instance.selectedPoi=this.poi)}}customElements.define("app-selected-suggested-path-card",Tn);class qt extends HTMLElement{constructor(){super();i(this,"shadowRoot");i(this,"_path",{...h.instance.selectedSuggestedPath});this.shadowRoot=this.attachShadow({mode:"closed"});const e=new CSSStyleSheet;e.replaceSync(Ln),this.shadowRoot.adoptedStyleSheets.push(e)}get path(){return this._path}set path(e){this._path=e}connectedCallback(){this.render(),this.setup(),this.update(),l.instance.publish("load-custom-path",this.path)}render(){this.shadowRoot.innerHTML=`
            <div class="header">
            ...
            <div class="list"></div>
            `}setup(){const e=this.shadowRoot.querySelector(".back-btn");e&&e.addEventListener("click",()=>{ue.instance.isSuggestedPathSelected=!1,ue.instance.currentTab=E.SuggestedPath});const n=this.shadowRoot.querySelector(".load-layers-btn");n&&n.addEventListener("click",()=>{const r=this.getLayersInPath();l.instance.publish("bench-all-layers",null),r.forEach(s=>l.instance.publish("add-layer",s))})}update(){const e=this.shadowRoot.querySelector(".list");e&&(e.innerHTML="",this.path.pois.forEach(n=>{let r=new Tn;r.poi=n,e.appendChild(r)}))}getLayersInPath(){let e=[];return this.path.pois.forEach(n=>e.push(n.layer)),[...new Set(e)]}}customElements.define("app-selected-suggested-path-panel",qt);const Vt=document.querySelector("app-router"),$t=new We("map",ve.Page,()=>"<page-map></page-map>"),Gt=new We("index",ve.Default,()=>"<page-tags></page-tags>"),Ut=new We("404",ve.NotFound,()=>"<div>404</div>"),Wt=[$t,Gt,Ut];Vt.addRoutes(Wt);ae.instance.getMapThemes().then(()=>ae.instance.getPreferColorScheme());h.instance.getTags();h.instance.getCsvPaths(1);h.instance.getSavedLayers();h.instance.getCustomPaths();
